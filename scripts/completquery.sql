...
INSERT INTO users (phone, password, role, name, email) VALUES
    ('213540000739', '$2b$10$rQZ9QZJ5HGmQ5LX5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5Q5', 'admin', 'Admin', 'admin@sisacake.com')
...
-- SELECT AVG(rating) as average_rating, COUNT(*) as total_reviews FROM cake_reviews WHERE cake_id = 'YOUR_CAKE_ID';

-- Get all reviews for a cake with rating
-- SELECT * FROM cake_reviews WHERE cake_id = 'YOUR_CAKE_ID' ORDER BY created_at DESC;

-- Get top rated cakes
-- SELECT c.id, c.title, AVG(cr.rating) as avg_rating, COUNT(cr.id) as review_count
-- FROM cakes c
-- LEFT JOIN cake_reviews cr ON c.id = cr.cake_id
